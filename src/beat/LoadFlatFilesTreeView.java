...
class LoadFlatFilesTreeView {
    ...
    List datfilesList = new ArrayList();
    private final Image daticon;
    private final Image datfileicon;
    private final TreeItem<String> dat;
...
//        flatfiletree.getChildrenUnmodifiable.clear();
        ...
        daticon = new Image(getClass().getResourceAsStream("/icon/txticon.png"));
        ...
        datfileicon = new Image(getClass().getResourceAsStream("/icon/xmlfileicon.png"));
        ...
        dat = new TreeItem<>("DAT", new ImageView(daticon));
    ...
    public void getFileNames() {
        ...
        System.out.println("datfilesList : " + datfilesList);
    ...
    public void adddatfilestree(List l) {

        TreeItem item = null;

        for (Object a : l) {

            item = new TreeItem<>(a.toString(), new ImageView(datfileicon));
            dat.getChildren().add(item);
        }
    }
